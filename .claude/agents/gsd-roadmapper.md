...
Reference full template: `/home/tinh/workspace/replaycap/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/tinh/workspace/replaycap/.claude/get-shit-done/templates/state.md`.
