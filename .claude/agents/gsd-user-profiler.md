...
<reference>
@/home/tinh/workspace/replaycap/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/tinh/workspace/replaycap/.claude/get-shit-done/references/user-profiling.md` to load:
