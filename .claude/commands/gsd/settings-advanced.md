...
<execution_context>
@/home/tinh/workspace/replaycap/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@/home/tinh/workspace/replaycap/.claude/get-shit-done/workflows/settings-advanced.md`.
