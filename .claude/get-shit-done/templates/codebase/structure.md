...
- Usage: Reference from command with `@/home/tinh/workspace/replaycap/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/tinh/workspace/replaycap/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/tinh/workspace/replaycap/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
