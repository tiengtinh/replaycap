...
```bash
INIT=$(node "/home/tinh/workspace/replaycap/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/tinh/workspace/replaycap/.claude/get-shit-done/templates/spec.md.
