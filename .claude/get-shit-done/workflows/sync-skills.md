...
INSTALL_JS_GLOBAL="/home/tinh/workspace/replaycap/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/tinh/workspace/replaycap/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
