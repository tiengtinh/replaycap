...
```
Task(
  prompt="Read /home/tinh/workspace/replaycap/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/tinh/workspace/replaycap/.claude/get-shit-done/templates/SECURITY.md`
