...
- **Global scope**: `/home/tinh/workspace/replaycap/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/tinh/workspace/replaycap/.claude/notes/`)
...
2. Glob `/home/tinh/workspace/replaycap/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/tinh/workspace/replaycap/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/tinh/workspace/replaycap/.claude/notes/` — works in any directory
