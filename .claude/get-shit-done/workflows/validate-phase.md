...
```
Task(
  prompt="Read /home/tinh/workspace/replaycap/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/tinh/workspace/replaycap/.claude/get-shit-done/templates/VALIDATION.md`
